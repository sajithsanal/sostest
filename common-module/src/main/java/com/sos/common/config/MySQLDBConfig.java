...
public class MySQLDBConfig {
    ...
    public DataSource getReadDataSource() {
        ...
        dataSourceBuilder.url("jdbc:mysql://" + readHostName + ":" + readPort + "/sos_schema?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
    ...
    public DataSource getWriteDataSource() {
        ...
        DataSourceBuilder dataSourceBuilder = DataSourceBuilder.create();
        dataSourceBuilder.url("jdbc:mysql://" + writeHostName + ":" + writePort + "/sos_schema?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
        dataSourceBuilder.username(userName);
        dataSourceBuilder.password(password);
        return dataSourceBuilder.build();
    }
